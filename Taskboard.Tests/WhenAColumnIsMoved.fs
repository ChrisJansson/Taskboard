...
[<Fact>]
let ``Column is moved`` () =
    let state = Given [ BoardCreated { Name = "Board"; Id = BoardId 1; };  ColumnCreated { Name = "Column 0"; Id = ColumnId 0}; ColumnCreated { Name = "Column 1"; Id = ColumnId 1} ]
...
let ``Cannot move unknown column`` () =
    let state = Given [ BoardCreated { Name = "Board"; Id = BoardId 1; };  ColumnCreated { Name = "Column 0"; Id = ColumnId 0}; ]
